<template>
  <div>
    <div
      v-if="show"
      class=" h-24 w-11/12 xl:w-3/4 m-auto grid grid-cols-2 items-center"
    >
      ...
      <div class="hidden lg:block">
        <div
          class="flex items-center text-base font-medium uppercase tracking-widest text-neut-dark"
        >
